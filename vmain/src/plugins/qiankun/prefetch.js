            ...
            switch ((_context.prev = _context.next)) {
              ...
              case 2:
                ...
                getExternalStyleSheets =
                  _yield$importEntry.getExternalStyleSheets;
...
function prefetchAfterFirstMounted(apps, opts) {
  window.addEventListener("single-spa:first-mount", function listener() {
    ...
    if (process.env.NODE_ENV === "development") {
      console.log(
        "[qiankun] prefetch starting after ".concat(mountedApps, " mounted..."),
        notMountedApps
      );
    }
    ...
    (function () {
      return (0, _tslib.__awaiter)(
        ...
        /* #__PURE__ */ _regenerator.default.mark(function _callee2() {
          var _yield$prefetchStrate,
            _yield$prefetchStrate2,
            criticalAppNames,
            _yield$prefetchStrate3,
            minorAppsName;
            ...
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                ...
                case 2:
                  ...
                  _yield$prefetchStrate2 =
                    _yield$prefetchStrate.criticalAppNames;
                  criticalAppNames =
                    _yield$prefetchStrate2 === void 0
                      ? []
                      : _yield$prefetchStrate2;
                  _yield$prefetchStrate3 = _yield$prefetchStrate.minorAppsName;
                  minorAppsName =
                    _yield$prefetchStrate3 === void 0
                      ? []
                      : _yield$prefetchStrate3;
                  prefetchImmediately(
                    appsName2Apps(criticalAppNames),
                    importEntryOpts
                  );
                  prefetchAfterFirstMounted(
                    appsName2Apps(minorAppsName),
                    importEntryOpts
                  );
